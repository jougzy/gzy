    ...
    .each(function (d) {
      ...
      if (d.index === 0 || d.index === 2) {
        ...
        const svg = cell.append("svg")
          .attr("width", "100%")
          .attr("height", 20) // 高度设置为20px
          .attr("display", "block")
          .attr("viewBox", "0 0 75 20"); // 视图框，宽度75，高度20
        ...
        const rect = svg.append("rect")
          .attr("width", widthBl + '%')
          .attr("height", '100%')
          .attr("x", d.index === 0 ? ((svgWidth - rectWidth) / svgWidth) * 75 : 0)
        ...
        const text = svg.append("text")
          ...
          .attr("y", 14) // 文字偏移量调整为14，以适应20px高的SVG
          .attr("font-size", 10) // 保持字体大小不变
